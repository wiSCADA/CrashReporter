################################################################################
# wisUtilities.cmake - part of CMake configuration of wiSCADA library
#
...
#
#   wis_check_package_found: Test varname-FOUND for case-insensitive varname
#
################################################################################
...
# uppercase.
#
macro(wis_check_package_found NAME SUCCESS)
  ...
  #message(STATUS "wis_check_package_found: ${SUCCESS}=${${SUCCESS}}")
endmacro()

#
# Pretty-print of given property of current directory.
#
function(wis_report_directory_property PROPNAME)
...
# For instance, on Windows, libraries get ABI version suffix wis_coreXY.{dll|lib}.
#
function(wis_target_output_name TARGET_NAME OUTPUT_NAME)
  if(NOT DEFINED TARGET_NAME)
    message(SEND_ERROR "Error, the variable TARGET_NAME is not defined!")
  endif()
  
  #if(NOT DEFINED ${PROJECTNAMEU}_VERSION)
  #  message(STATUS "Waring, the variable ${${PROJECTNAMEU}_VERSION} is not defined!")
  #endif()

  # # On Windows, ABI version is specified using binary file name suffix.
  # # On Unix, suffix is empty and SOVERSION is used instead.
  # if (WIN32)
    # string(LENGTH "${${PROJECTNAMEU}_ABI_VERSION}" abilen)
    # if(abilen GREATER 0)
      # set(SUFFIX "_${${PROJECTNAMEU}_ABI_VERSION}")
    # endif()
  # endif()
  ...
  # On Unix, suffix is empty and SOVERSION is used instead.
	IF (CMAKE_BUILD_TYPE MATCHES Debug)		
		IF(WIN32)
			set(${OUTPUT_NAME} ${TARGET_NAME}${WIS_DEBUG_POSTFIX} PARENT_SCOPE)
		ELSEIF(APPLE)
			set(${OUTPUT_NAME} ${TARGET_NAME}${WIS_DEBUG_POSTFIX} PARENT_SCOPE)
		ELSE()
